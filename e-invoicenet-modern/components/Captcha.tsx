  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        ...
        <span className="text-2xl font-mono font-bold tracking-widest text-slate-700" style={{
        ...
        {/* Interference lines */}
        <div className="absolute top-1/2 left-0 w-full h-[1px] bg-slate-300 transform -rotate-12"></div>
        <div className="absolute top-1/2 left-0 w-full h-[1px] bg-slate-300 transform rotate-6"></div>
      </div>
